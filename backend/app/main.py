...
def _build_service_registry(settings: Settings, session_factory) -> ServiceRegistry:
    ...
    approval_service = ApprovalService(session_factory=session_factory, event_service=event_service)
    ...
    return ServiceRegistry(
        ...
        account_service=AccountService(session_factory=session_factory, settings=settings),
        task_service=task_service,
        event_service=event_service,
        approval_service=approval_service,
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        app.state.services = _build_service_registry(app_settings, session_factory)
